  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* 1v1 Format */}
        <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-white hover:shadow-xl transition-all cursor-pointer">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-lg">Classic one-on-one debate format</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button className="w-full mt-6" onClick={() => handleFormatSelect('1v1')}>
              Select 1v1 Format
            </Button>
          </CardContent>
        </Card>
        ...
        {/* 3v3 Format */}
        <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-white hover:shadow-xl transition-all cursor-pointer">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-lg">Team-based debate format</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
